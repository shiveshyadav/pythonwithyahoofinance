...
with open(file_path, 'r') as file:
    ...
    for row in csv_reader:
        ...
        df = yf.download(ticker, period="1y",interval='1wk',progress=False)  # Adjust the period as needed
        ...
        df2 = yf.download(ticker, period="1y",interval='1wk',progress=False)  # Adjust the period as needed
